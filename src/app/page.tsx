        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            {['Platform', 'Security', 'Clinical Workflow'].map((item) => (
              <Link 
                ...
                className="text-sm font-bold text-slate-500 hover:text-blue-600 transition-colors uppercase tracking-widest text-[10px]"
              >
                {item}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/login" className="hidden sm:block">
              <Button variant="ghost" className="text-xs font-black uppercase tracking-widest hover:bg-slate-50">Sign In</Button>
            </Link>
            <Link href="/login">
      ...
      <main className="relative">
        ...
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 flex flex-col items-center justify-center text-center">
          <div className="max-w-5xl mx-auto px-6 space-y-12">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-slate-50 border border-slate-100 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500"
            >
        ...
        <section className="py-20 border-y border-slate-50">
          <div className="max-w-7xl mx-auto px-6">
            <p className="text-center text-[10px] font-black uppercase tracking-[0.3em] text-slate-300 mb-12">Trusted by global medicine leaders</p>
            <div className="flex flex-wrap justify-center items-center gap-16 md:gap-32 opacity-20 hover:opacity-100 transition-all duration-700">
              {trustLogos.map((logo) => (
                <div key={logo} className="text-3xl font-black tracking-tighter text-slate-900 italic uppercase">{logo}</div>
              ))}
            </div>
          </div>
        </section>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  >
                    ...
                    <p className="font-bold uppercase tracking-widest text-[10px] text-slate-500">{stat.label}</p>
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-24">
            ...
            {['Platform', 'Security', 'Company'].map((title) => (
              <div key={title} className="space-y-6">
                ...
                <div className="flex flex-col gap-4">
                  <Link href="#" className="text-slate-500 hover:text-blue-600 text-sm font-bold transition-colors">Documentation</Link>
                  <Link href="#" className="text-slate-500 hover:text-blue-600 text-sm font-bold transition-colors">Infrastructure</Link>
                  <Link href="#" className="text-slate-500 hover:text-blue-600 text-sm font-bold transition-colors">Compliance</Link>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-8">
              <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-blue-600 transition-colors">Privacy Policy</Link>
              <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-blue-600 transition-colors">Terms of Service</Link>
            </div>
          </div>
        </div>
      </footer>
